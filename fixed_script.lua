...
-- (removed duplicate) local Players = game:GetService("Players")
...
-- (removed duplicate) local RunService = game:GetService("RunService")
...
-- (removed duplicate) local Lighting = game:GetService("Lighting")
-- (removed duplicate) local RunService = game:GetService("RunService")
